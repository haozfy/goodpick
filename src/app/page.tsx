...
import { Scan, Search, ChevronRight } from "lucide-react";
    ...
    <div className="min-h-screen bg-neutral-50 pb-28">
        ...
        <div className="relative overflow-hidden rounded-[32px] bg-neutral-900 p-8 text-white shadow-xl shadow-neutral-200">
          <div className="relative z-10 flex flex-col items-center text-center">
            ...
            <p className="mt-2 text-neutral-400 max-w-[200px]">
              Take a photo of food to see the truth.
            </p>
      ...
      <div className="px-6">
        ...
        <div className="space-y-3">
          <HistoryItem href="/product" name="Oat Milk Original" brand="Oatly" score={92} time="2m ago" />
          <HistoryItem href="/product" name="Tomato Ketchup" brand="Heinz" score={45} time="1h ago" />
        </div>
      </div>
    </div>
  );
